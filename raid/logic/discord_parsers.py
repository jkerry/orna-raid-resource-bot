...
class MessageParser:
    ...
    async def send_allotment(self, message):
        # TODO: calc and send through the kingdom object, store message ids
        ...
        #find the previous messages by channel / id
        #delete old messages
        ...
        message_ids = []
        header_msg = await msg_channel.send("Raid Allotments:")
